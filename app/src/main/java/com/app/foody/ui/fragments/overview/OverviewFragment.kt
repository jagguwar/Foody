package com.app.foody.ui.fragments.overview
...
class OverviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (myBundle?.vegetarian == true) {
            view.vegeterian_imageView.setColorFilter(ContextCompat.getColor(requireContext(), R.color.green))
            view.vegeterian_textView.setTextColor(ContextCompat.getColor(requireContext(), R.color.green))
        }
